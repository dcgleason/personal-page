        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              I&apos;m Dan Gleason. I live in a small town in Conneticut, and I love to
              create. 
            </h1>
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              <p>
                I&apos;ve loved to build / create things for as long as I can remember. Since I started learning to code in 
                2015, my creativity has &quot;scewed digital.&quot; Before 2015, I staying creative by pursuing things like photography and writing in my spare time. Now, almost eight years later, while I still enjoy writing and photography, I also have fun building
              ...
              <p>
                If you&apos;d like to work with or hire me, don&apos;t hesitatate to reach out -- would love to learn more and see if I can be of any help. 
              </p>
            </div>
          </div>
          <div className="lg:pl-20">
