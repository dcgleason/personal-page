              ...
              <footer className="mt-8">
                <div className="md:flex md:items-center md:justify-center">
                  ...
                  <div className="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                    <div className="text-base font-medium text-gray-900">Addam Driver</div>
  
                    <svg className="mx-1 hidden h-5 w-5 text-indigo-600 md:block" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M11 0h3L9 20H6l5-20z" />
                    </svg>
  
                    <div className="text-base font-medium text-gray-500">Lead Solutions Architect, U.S. Department of Health and Human Services</div>
                  </div>
                </div>
              </footer>
            </blockquote>
